...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { followed_act_id: @relationship.followed_act_id, follower_user_id: @relationship.follower_user_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { followed_act_id: @relationship.followed_act_id, follower_user_id: @relationship.follower_user_id } }
